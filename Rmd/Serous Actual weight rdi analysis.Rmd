...
# `r emo::ji("spiral_notepad")` This report is using **actual weight** in OC with **SEROUS** histology.  
...
- include patients whose histology of SEROUS CANCER    
...
patientid, month_at_os_from_treatment, vital_status, raceeth, ageatdx, stagecat, debulking, diagnosisdate, surgerydate, RDI_carbo_neo, RDI_pacli_neo, RDI_carbo_adj, RDI_pacli_adj BUT NOT therapy.  
...
data <- Frontline %>% 
  ...
  select(patientid, month_at_os_from_treatment, vital_status, 
         ...
         ageatdx, stagecat, debulking,
         RDI_carbo_neo, RDI_pacli_neo, 
         RDI_carbo_adj, RDI_pacli_adj
         # therapy
  )
nonimp_cox_model <-
  coxph(Surv(month_at_os_from_treatment, vital_status) ~ RDI_carbo_neo + RDI_pacli_neo + RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + stagecat + debulking,
        data = data)
nonimp_cox_model
...
check1 <- with(data = Cox.imp,
       exp = coxph(
         Surv(month_at_os_from_treatment, vital_status) ~ RDI_carbo_neo + RDI_pacli_neo + RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + stagecat + debulking
       ))
# pool(check1)$pooled
...
Select the variables that may be important for predicting stagecat and debulking status:  
patientid, month_at_os_from_treatment, vital_status, raceeth, ageatdx, stagecat, debulking, diagnosisdate, surgerydate, RDI_carbo_adj, RDI_pacli_adj BUT NOT therapy.  
...
nonimp_cox_model <-
  coxph(Surv(month_at_os_from_treatment, vital_status) ~ RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + stagecat + debulking,
        data = data)
nonimp_cox_model
...
check1 <- with(data = Cox.imp,
       exp = coxph(
         Surv(month_at_os_from_treatment, vital_status) ~ RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + stagecat + debulking
       ))
# pool(check1)$pooled
multiple_imputations_number <- round(max(pool(check1)$pooled$fmi),2)*100
```
...
`imp_stagecat + imp_debulking` 
```{r Table 5 HR adjusted rdi group}
tbl2 <- Frontline %>%
  filter(therapy == "Upfront Chemo")
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_adj_grp + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj_grp + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("carboplatin Neo/Upfront Chemo", 
                           "carboplatin Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_neo_grp + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_adj_grp + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_pacli_adj_grp + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_adj_grp + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj_grp + raceeth + ageatdx + imp_stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("carboplatin Neo/Upfront Chemo", 
                           "carboplatin Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_neo_grp + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_adj_grp + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_pacli_adj_grp + raceeth + ageatdx + imp_stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("paclitaxel Neo/Upfront Chemo", 
                           "paclitaxel Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_adj + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("carboplatin Neo/Upfront Chemo", 
                           "carboplatin Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_neo + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_adj + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_pacli_adj + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("paclitaxel Neo/Upfront Chemo", 
                           "paclitaxel Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_adj + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj + raceeth + ageatdx + imp_stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("carboplatin Neo/Upfront Chemo", 
                           "carboplatin Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_neo + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_adj + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_pacli_adj + raceeth + ageatdx + imp_stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("paclitaxel Neo/Upfront Chemo", 
                           "paclitaxel Adj/Upfront Chemo",
...
`RDI_carbo_neo_grp + RDI_pacli_neo_grp + RDI_carbo_adj_grp + RDI_pacli_adj_grp +`
`raceeth + ageatdx + imp_stagecat + imp_debulking` 
```{r Table 5 HR adjusted rdi group adjusted by other drug}
tbl2 <- Frontline %>%
  filter(therapy == "Upfront Chemo")
tbl21 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + RDI_pacli_neo_grp + RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl31 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + strata(imp_stagecat) + imp_debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl21, tbl31),
          group_header = c("Upfront Chemo", "Upfront Surgery")) %>%
  bold_labels() %>%
...
coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status
           ) ~ RDI_carbo_neo_grp + RDI_pacli_neo_grp + RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + imp_stagecat + imp_debulking, 
      data =  tbl2)  %>% 
  cox.zph()
```
...
coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status
           ) ~ RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + strata(imp_stagecat) + imp_debulking, data =  
        tbl3) %>%
  cox.zph()
```
...
`coxph(Surv(time = month_at_os_from_treatment, event = vital_status)~ `
`RDI_carbo_neo_grp + RDI_pacli_neo_grp + RDI_carbo_adj_grp + RDI_pacli_adj_grp + `
`raceeth + ageatdx + imp_stagecat` 
```{r}
tbl2 <- Frontline %>%
  filter(therapy == "Upfront Chemo")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + RDI_pacli_neo_grp + RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + imp_stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
...
tbl21 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + RDI_carbo_adj_grp + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl31 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj_grp + raceeth + ageatdx + strata(imp_stagecat) + imp_debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl21, tbl31),
          group_header = c("Upfront Chemo", "Upfront Surgery")) %>%
  bold_labels() %>%
...
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + RDI_carbo_adj_grp + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
...
tbl21 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo + RDI_pacli_neo + RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl31 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl21, tbl31),
          group_header = c("Upfront Chemo", "Upfront Surgery")) %>%
  bold_labels() %>%
...
```{r prop H c}
coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo + RDI_pacli_neo + RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + imp_stagecat + raceeth + ageatdx + imp_stagecat + imp_debulking, data =  tbl2)  %>% 
  cox.zph()
```
...
`coxph(Surv(time = month_at_os_from_treatment, event = vital_status) ~ `
`RDI_carbo_neo + RDI_pacli_neo + RDI_carbo_adj + RDI_pacli_adj +`
`raceeth + ageatdx + stagecat` 
```{r}
tbl2 <- Frontline %>%
  filter(therapy == "Upfront Chemo")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo + RDI_pacli_neo + RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + imp_stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + imp_stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl2, tbl3),
          group_header = c("Upfront Chemo", "Upfront Surgery")) %>%
  bold_labels() %>%
...
`raceeth + ageatdx + stagecat + debulking` 
```{r}
tbl2 <- Frontline %>%
  filter(therapy == "Upfront Chemo")
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_adj_grp + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj_grp + raceeth + ageatdx + stagecat + debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("carboplatin Neo/Upfront Chemo", 
                           "carboplatin Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_neo_grp + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_adj_grp + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_pacli_adj_grp + raceeth + ageatdx + stagecat + debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("paclitaxel Neo/Upfront Chemo", 
                           "paclitaxel Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_adj_grp + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj_grp + raceeth + ageatdx + stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("carboplatin Neo/Upfront Chemo", 
                           "carboplatin Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_neo_grp + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_adj_grp + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_pacli_adj_grp + raceeth + ageatdx + stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("paclitaxel Neo/Upfront Chemo", 
                           "paclitaxel Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_adj + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj + raceeth + ageatdx + stagecat + debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("carboplatin Neo/Upfront Chemo", 
                           "carboplatin Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_neo + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_adj + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_pacli_adj + raceeth + ageatdx + stagecat + debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("paclitaxel Neo/Upfront Chemo", 
                           "paclitaxel Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_adj + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj + raceeth + ageatdx + stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("carboplatin Neo/Upfront Chemo", 
                           "carboplatin Adj/Upfront Chemo",
...
tbl1 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_neo + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_pacli_adj + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_pacli_adj + raceeth + ageatdx + stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl1, tbl2, tbl3),
          group_header = c("paclitaxel Neo/Upfront Chemo", 
                           "paclitaxel Adj/Upfront Chemo",
...
tbl21 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + RDI_pacli_neo_grp + RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
...
tbl31 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status
             ) ~ RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + strata(stagecat) + debulking, 
        data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% 
  bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
...
coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status
           ) ~ RDI_carbo_neo_grp + RDI_pacli_neo_grp + RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + stagecat + debulking, 
      data =  tbl2)  %>% 
  cox.zph()
```
...
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + RDI_pacli_neo_grp + RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj_grp + RDI_pacli_adj_grp + raceeth + ageatdx + stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl2, tbl3),
          group_header = c("Upfront Chemo", "Upfront Surgery")) %>%
  bold_labels() %>%
...
tbl21 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + RDI_carbo_adj_grp + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
...
tbl31 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status
             ) ~ RDI_carbo_adj_grp + raceeth + ageatdx + strata(stagecat) + debulking, 
        data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% 
  bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
...
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo_grp + RDI_carbo_adj_grp + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
...
tbl21 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo + RDI_pacli_neo + RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + stagecat + debulking, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl31 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + stagecat + debulking, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl21, tbl31),
          group_header = c("Upfront Chemo", "Upfront Surgery")) %>%
  bold_labels() %>%
...
tbl2 <- 
  coxph(Surv(time = tbl2$month_at_os_from_treatment, 
             event = tbl2$vital_status) ~ RDI_carbo_neo + RDI_pacli_neo + RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + stagecat, data =  tbl2) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl3 <- Frontline %>%
  filter(therapy == "Upfront Surgery")
tbl3 <- 
  coxph(Surv(time = tbl3$month_at_os_from_treatment, 
             event = tbl3$vital_status) ~ RDI_carbo_adj + RDI_pacli_adj + raceeth + ageatdx + stagecat, data =  tbl3) %>%
  tbl_regression(exponentiate = TRUE) %>% bold_p(t = .05) %>% add_nevent(location = "level") %>% add_n(location = "level")
tbl_stack(list(tbl2, tbl3),
          group_header = c("Upfront Chemo", "Upfront Surgery")) %>%
  bold_labels() %>%
