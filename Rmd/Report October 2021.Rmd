...
<span style="color:red">**Should we exclude patients who received a platinum + Clinical study drug or a taxane + clinical study drug as we don’t know what the clinical study drug is – is it possible that it could include a platinum or taxane based drug?**</span>  
```{r}
