...
therapy_line <- drugs1 %>% 
  ...
  # F0000AD999ABF, F1C68CFAC2AF3, FBCF69031DFF8, F0040EA299CF0, FAACDC7205803,  FA019D2071321 no has big jump F95D860690A93 still weird F0F1324B863A8
...
Treatment <- Treatment1 %>% 
  ...
  mutate(line_keep = case_when(# F002B429BE6C6
    (linenumber_adj == 1 &
           ...
           linename == "Bevacizumab,Carboplatin"))            ~ "include"
  )) %>% 
  group_by(patientid) %>%
