...
Patients with part of their first line switched to Adjuvant line because of surgery. How long is this adjuvant line?
```{r}
therapy_line %>% 
...
### Number of line in treatment and cycle in frontline (more cleaning needs to be done here)
...
Frontline <- Frontline %>% 
  filter(str_detect(drugname, "platin|taxel"))
```
...
# tbl1 <- 
  ...
  select(c(raceeth, #delay_incare_dx_to_treat, #mean_skipped_cycle_indays,
           "issurgery", "resdz", "debulking", "diff_surg_dx",
           # had_neo, had_adj,
           "therapy", "treatment_sequence"#, "relative_dose_intensity", "RDI_grp"
           )) %>% 
...
tbl1 <- Frontline %>% filter(drugname == "carboplatin" & chemotherapy_type == "Adjuvant" & therapy == "Upfront Surgery") %>%
  distinct(patientid, .keep_all = TRUE) %>%
  select(c("relative_dose_intensity", RDI_grp)) %>%
  tbl_summary(
...
tbl_stack(list(tbl1, tbl2, tbl3, tbl4, tbl5, tbl6), quiet = TRUE)
```
...
Frontline %>% filter(!is.na(relative_dose_intensity)) %>%
  # filter(linenumber_new == "1") %>%
  ggplot(aes(x= drugname, y= relative_dose_intensity, color = chemotherapy_type))+
  geom_violin()+
  ylim(c(-.25, 3.5))+
  # geom_jitter(shape=16, aes(color=relative_dose_intensity<0.85))+
  theme_minimal(base_size = 14)+
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis carboplatin Neo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis paclitaxel Neo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis PPB Neo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis carboplatin Adj Upfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis cisplatin Adj Upfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis PPB Adj Upfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis carboplatin Adj Upfront Chemo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis cisplatin Adj Upfront Chemo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment carboplatin Neo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment paclitaxel Neo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment PPB Neo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment carboplatin Adj Upfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment cisplatin Adj Upfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment PPB Adj Upfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment carboplatin Adj Upfront Chemo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment cisplatin Adj Upfront Chemo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
## Multivariable
`coxph(Surv(time = month_at_os, event = vitalstatus)~RDI_grp + raceeth + ageatdx + stagecat` (ageatdx or agecat?)
...
### By drug
`RDI_grp ~ agecat + raceeth + stagecat + histology + bmi_cat`
```{r}
#  for carbo
