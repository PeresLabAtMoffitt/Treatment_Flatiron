...
Frontline <- Treatment %>% 
  ...
  mutate(RDI_grp1 = factor(RDI_grp1, 
                          labels = c("correct", "highly underdose", "underdose", "perfect", "higher dose", "overdose")))
```
<br>
<br>
<br>
...
Frontline %>% filter(!is.na(relative_dose_intensity)) %>%
  # filter(linenumber_new == "1") %>%
  ggplot(aes(x= chemotherapy_type, y= relative_dose_intensity, color = chemotherapy_type))+
  geom_violin()+
  ylim(c(-.25, 3.5))+
  # geom_jitter(shape=16, aes(color=relative_dose_intensity<0.85))+
  theme_minimal(base_size = 14)+
...
Frontline %>% filter(!is.na(relative_dose_intensity)) %>%
  # filter(linenumber_new == "1") %>%
  ggplot(aes(x= raceeth, y= relative_dose_intensity#, alpha = relative_dose_intensity<0.85
             ))+
...
As you will saw, we have a big spread of RDI (it is more than < or > 0.85) so I thought I could make more than 2 groups to compare patients who have a correct RDI or being underdose or overdose
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis cisplatin Neo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis carboplatin Adj \nUpfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis cisplatin Adj \nUpfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis paclitaxel Adj \nUpfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from diagnosis PPB Adj \nUpfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment cisplatin Neo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment carboplatin Adj \nUpfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment cisplatin Adj \nUpfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment paclitaxel Adj \nUpfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment PPB Adj \nUpfront Surgery",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
...
ggsurvplot(survfit(Surv(month_at_os_from_treatment, vitalstatus) ~ RDI_grp, 
           ...
           title = "OS from first treatment pacliatxel Adj \nUpfront Chemo",
           font.main = c(24, "bold", "black"),
           font.x = c(20, "bold", "black"), font.y = c(20, "bold", "black"),
           font.legend = c(14, "bold", "black"), font.tickslab = c(18, "bold", "black"),
           size = 1.5,
